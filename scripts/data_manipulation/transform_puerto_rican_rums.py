#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Transformacja nazw rumow z Puerto Rico do postaci keywordow dla estymatora.

Wejscie:  data/puerto_rican_rums.csv                       (kolumna `brand`)
Wyjscie:  data/transformed/puerto_rican_rums_transformed.csv  (kolumny `brand`, `keyword`)
...
KONFIGURACJA. Skan znakow potwierdzil, ze w tym pliku wystepuja wylacznie
diakrytyki (á, ñ, ó) -- wszystkie rozkladaja sie przez NFKD; brak '&', '/', ABV
i dopiskow opisowych, wiec te reguly po prostu nie odpalaja.

Generyczne slowa "Ron"/"Rum" sa ZACHOWANE w nazwie (jak "Vodka" w wodce):
"Ron Palo Viejo" -> "ron-palo-viejo", "Boca Chica Rum" -> "boca-chica-rum".

Uruchomienie (z dowolnego cwd -- sciezki liczone wzgledem __file__):
    python3 scripts/data_manipulation/transform_puerto_rican_rums.py
"""
...
PLIK_WEJSCIOWY = DATA_DIR / "puerto_rican_rums.csv"
KATALOG_WYJSCIOWY = DATA_DIR / "transformed"
PLIK_WYJSCIOWY = KATALOG_WYJSCIOWY / "puerto_rican_rums_transformed.csv"
